...
<template>
	<Sonner
		...
		:toast-options="{
			classes: {
				toast: 'group toast group-[.toaster]:bg-white-light dark:group-[.toaster]:bg-black-light text-black-dark dark:text-white-light font-sans group-[.toaster]:border-primary group-[.toaster]:shadow-lg',
				description: 'group-[.toast]:text-muted-foreground',
				actionButton: '!bg-primary text-white-light',
			},
		}"
	/>
</template>
