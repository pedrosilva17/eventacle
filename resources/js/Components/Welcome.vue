...
<template>
	<div>
		...
		>
			...
			<h1 class="mt-8 text-2xl font-medium text-gray-900 dark:text-white-light">
		...
		>
			<div>
				<div class="flex items-center">
					...
					<h2 class="ms-3 text-xl font-semibold text-gray-900 dark:text-white-light">
			...
			<div>
				<div class="flex items-center">
					...
					<h2 class="ms-3 text-xl font-semibold text-gray-900 dark:text-white-light">Authentication</h2>
				</div>
