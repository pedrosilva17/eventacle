...
<template>
	<ActionSection>
		...
		<template #content>
			...
			<h3 v-else class="text-lg font-medium text-black-dark dark:text-white-light">
			...
			<div v-if="twoFactorEnabled">
				<div v-if="qrCode">
					...
					<div v-if="setupKey" class="mt-4 max-w-xl text-sm text-black-dark dark:text-white-light">
				...
				<div v-if="recoveryCodes.length > 0 && !confirming">
					...
					<div
						class="mt-4 grid max-w-xl gap-1 rounded-lg bg-white px-4 py-4 font-mono text-sm dark:bg-black dark:text-gray-100"
					>
